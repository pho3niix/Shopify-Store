      ...
      >
        ...
        >
          ...
          >
            <Typography
              variant="h1"
              fontSize={{ xs: "2.5rem", sm: "3.5rem", md: "4.2rem", lg: "5.5rem" }}
              lineHeight={0.8}
              textAlign={"center"}
              fontWeight={400}
              color={"primary.main"}
            ...
            <Typography
              variant="h1"
              fontSize={{ xs: "2.3rem", sm: "3.5rem", md: "4rem", lg: "5.5rem" }}
              fontWeight={400}
          ...
          >
            ...
            >
              ...
              eu velit finibus, cursus nunc ornare, mattis ex. Etiam sagittis
              magna sit amet purus interdum, vitae eleifend nisl molestie Lorem
              ipsum dolor sit amet, consectetur adipiscing elit. Quisque eu
              velit finibus, cursus nunc ornare, mattis ex. Etiam sagittis magna
              sit amet purus interdum, vitae eleifend nisl molestie Lorem ipsum
              dolor sit amet, consectetur adipiscing elit. Quisque eu velit
              finibus, cursus nunc ornare, mattis ex. Etiam sagittis magna sit
              amet purus interdum, vitae eleifend nisl molestie
            </Typography>
          </Stack>
        </Stack>
        {/* ---------------------------Section 2--------------------------- */}
        ...
        >
          ...
          >
            ...
            >
              ...
              magna sit amet purus interdum, vitae eleifend nisl molestie Lorem
              ipsum dolor sit amet, consectetur adipiscing elit. Quisque eu
              velit finibus, cursus nunc ornare, mattis ex.
            </Typography>
        ...
        >
          ...
          >
            <Typography
              variant="h1"
              fontSize={{ xs: "2.3rem", sm: "3rem", md: "3.8rem", lg: "4.5rem" }}
              fontWeight={400}
            ...
            >
              ...
              magna sit amet purus interdum, vitae eleifend nisl molestie Lorem
              ipsum dolor sit amet, consectetur adipiscing elit. Quisque eu
              velit finibus, cursus nunc ornare, mattis ex. Lorem ipsum dolor
              sit amet, consectetur adipiscing elit. Quisque eu velit finibus,
              cursus nunc ornare, mattis ex. Etiam sagittis magna sit amet purus
              interdum, vitae eleifend nisl molestie Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Quisque eu velit finibus, cursus nunc
              ornare, mattis ex.
            </Typography>
          </Stack>
          <Box
